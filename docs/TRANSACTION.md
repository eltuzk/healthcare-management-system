...
Cần transaction khi hệ thống ghi nhận thanh toán từ SePay webhook hoặc từ tiền mặt walk-in. Flow thanh toán cập nhật nhiều bảng và cần xử lý idempotency để tránh ghi nhận trùng giao dịch.
...
Project có 6 nhóm transaction chính:
...
- Release slot.
- Thanh toán.
- Medical record và doctor schedule.
